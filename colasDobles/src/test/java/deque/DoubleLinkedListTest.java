...
public class DoubleLinkedListTest {
    ...
    @Test
    @DisplayName("Remove no elimina nada lista vacia")
    ...
    @Test
    @DisplayName("sort devuelve una lista vacia si la lista no contiene ningun elemento")
    public void sortTest_CeroElementos_throwsException(){
        DoubleLinkedList<Integer> colaDoble = new DoubleLinkedList<>();
        assertThrows(DoubleLinkedQueueException.class, () -> colaDoble.sort(Integer::compareTo));
    }

    @Test
    @DisplayName("jj")
    public void sortTest_MasDeUnElemento_returnTrue(){
        DoubleLinkedList<Integer> colaDoble = new DoubleLinkedList<>();
        Integer int1 = 2;
        Integer int2 = 3;
        Integer int3 = 1;
        colaDoble.append(int1);
        colaDoble.append(int2);
        colaDoble.append(int3);
        colaDoble.sort(Integer::compareTo);
        assertEquals(colaDoble.first(), 1);
        assertEquals(colaDoble.last(), 3);
    }

    @Test
    @DisplayName("sort devuelve la misma lista si solo tiene un elemento")
    public void sortTest_UnElemento_returnTrue(){
        DoubleLinkedList<Integer> colaDoble = new DoubleLinkedList<>();
        Integer int1 = 1;
        colaDoble.append(int1);
        colaDoble.sort(Integer::compareTo);
        assertEquals(colaDoble.first(), int1);
        assertEquals(colaDoble.last(),int1);
    }
